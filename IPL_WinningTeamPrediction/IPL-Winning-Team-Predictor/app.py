...
LogReg = joblib.load('LogReg.joblib')  # If the file has a .pkl extension
Rf = joblib.load('Rf.joblib')  # Update the file extension
dt_clf = joblib.load('dt_clf.joblib')  # Update the file extension
